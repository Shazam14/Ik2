...
public class LocationService extends Service implements
    ...
    public void onCreate() {
        super.onCreate();
        SharedPreferences sharedPreferences = this.getSharedPreferences("com.aries.prefs", Context.MODE_PRIVATE);
        ...
        if (firstTimeLoadindApp) {
            ...
            editor.putString("userName", "ikodeUser");
            editor.apply();
        }
        defaultUploadWebsite = "http://192.168.1.64:8080/GPSTrackerMap/updatelocation.php";
    }
